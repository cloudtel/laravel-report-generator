...
use Cloudtel\ReportGenerator\ReportMedia\CSVReport;
use Cloudtel\ReportGenerator\ReportMedia\PdfReport;
use Cloudtel\ReportGenerator\ReportMedia\ExcelReport;
...
class ServiceProvider extends IlluminateServiceProvider
{
	...
	protected function registerAliases()
	{
	    if (class_exists('Illuminate\Foundation\AliasLoader')) {
	        ...
	        $loader->alias('PdfReport', \Cloudtel\ReportGenerator\Facades\PdfReportFacade::class);
	        $loader->alias('ExcelReport', \Cloudtel\ReportGenerator\Facades\ExcelReportFacade::class);
	        $loader->alias('CSVReport', \Cloudtel\ReportGenerator\Facades\CSVReportFacade::class);
	    }
	}
